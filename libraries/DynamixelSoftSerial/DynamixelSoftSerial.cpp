...
extern SoftwareSerial SoftSerial(2, 3, PORTD);
...
#define delayus(args) (_delay_us(args))  // Delay Microseconds

// Macro for Comunication Flow Control

#define switchCom(Mode) (SoftSerial.setMode(Mode))  // Switch to TX/RX Mode
